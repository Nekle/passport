...
Authenticator.prototype.authenticate = function(strategy, options, callback) {
  var authenticate = this._framework.authenticate(this, strategy, options, callback);
  var self = this;
  return function (data) {
    function next() {
      authenticate(data);
    }
    self._framework.initialize(this)(data, next);
  };
};
 ...
 * @api public
 */
Authenticator.prototype.serializeUser = function(fn, data, done) {
 ...
 * @api public
 */
Authenticator.prototype.deserializeUser = function(fn, data, done) {
  if (typeof fn === 'function') {
